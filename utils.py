...
def setPlayerCameras():
    ...
    if len(globals.players) == 1:
        ...
        #p.camera._updateWorldPos(p.position.initialRect.x, p.position.initialRect.y)
    ...
    if len(globals.players) == 2:
        ...
        #p1.camera._updateWorldPos(p1.position.initialRect.x, p1.position.initialRect.y)
        ...
        #p2.camera._updateWorldPos(p2.position.initialRect.x, p2.position.initialRect.y)
    ...
    if len(globals.players) >= 3:
        ...
        #p3.camera._updateWorldPos(p3.position.initialRect.x, p3.position.initialRect.y)
        ...
        if len(globals.players) == 4:
            ...
            #p4.camera._updateWorldPos(p4.position.initialRect.x, p4.position.initialRect.y)
...
def resetPlayer(entity):
    ...
    #entity.camera._updateWorldPos(entity.position.initialRect.x, entity.position.initialRect.y)
